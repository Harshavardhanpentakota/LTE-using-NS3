...
// std::vector<uint64_t> prevThroughput(40, 0);
// static void func(Ptr<PacketSink> sink, double deltaTime, int index, double currentTime)
// {
//     if (sink->GetNode()->GetId() == 13)
//     {
//         uint64_t presentThroughput = sink->GetTotalRx();
//         // NS_LOG_INFO(sink->GetNode()->GetId() + " " + presentThroughput - prevThroughput[index]);
//         std::cerr << currentTime << " " << presentThroughput - prevThroughput[index] << std::endl;
...
int main(int argc, char* argv[])
{
    ...
    std::string scheduler = "ns3::TdMtFfMacScheduler";
    uint16_t seedvalue = 33;
    Config::SetDefault ("ns3::RandomWalk2dMobilityModel::Mode", StringValue ("Time"));
    Config::SetDefault ("ns3::RandomWalk2dMobilityModel::Time", StringValue ("2s"));
    Config::SetDefault ("ns3::RandomWalk2dMobilityModel::Speed", StringValue ("ns3::ConstantRandomVariable[Constant=0.0]"));
    ...
    RngSeedManager::SetSeed(seedvalue); // Changes seed from default of 1 to 3 rand(30,1) % 1
    ...
    mobility2.SetPositionAllocator("ns3::RandomDiscPositionAllocator",
                                   ...
                                   StringValue("0.0"),
                                   "Rho",
                                   StringValue("ns3::UniformRandomVariable[Min=500|Max=500]"));
    mobility2.SetMobilityModel("ns3::ConstantPositionMobilityModel"//,RandomWalk2dMobilityModel ConstantPositionMobilityModel
    ...
    for (uint32_t u = 0; u < ueNodes.GetN(); ++u)
    {
        ...
        // Simulator::Schedule(MilliSeconds(300),
        //                     &func,
        //                     DynamicCast<PacketSink>(serverApps.Get(u)),
        //                     1,
        //                     u,
        //                     Simulator::Now().GetSeconds());
    }
   ...
   // Mean flow throughput:
    std::cerr << "\n========================================================================\n";
    std::cerr << "\n\n  Aggregrate system throughput: " << averageFlowThroughput<< "\n";
    "\n========================================================================\n";
